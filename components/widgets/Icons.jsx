export function EosIconsContentNew(props) {
  return (
    <svg
...
export function MingcuteEditLine(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1.5rem"
...
export function HealthiconsIExamMultipleChoiceOutline(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1.5rem"
...
export function CharmGem(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1.5rem"
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="M4.75 2.75h6.5l3 3.5l-6.25 7l-6.25-7z"
      ></path>
    </svg>
  );
}

export function MdiUserOutline(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1.5rem"
...
export function MaterialSymbolsLogout(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1.5rem"
