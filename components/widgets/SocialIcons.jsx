export function MdiYoutube({ fill = "white", ...props }) {
  return (
    <svg
...
export function MdiFacebook({ fill = "white", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2rem"
...
export function MdiInstagram({ fill = "white", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2rem"
...
export function RiTwitterXFill({ fill = "white", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2rem"
